    ...
    return (
      <div className="rounded-card border border-mist bg-white p-8">
        ...
        <a
          ...
          className="mt-6 inline-flex min-h-[44px] items-center justify-center rounded-control bg-teal px-6 text-ui-label text-white hover:bg-teal-hover"
        >
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-card border border-mist bg-white p-8">
      ...
      <button
        ...
        className="mt-6 inline-flex min-h-[44px] items-center justify-center rounded-control bg-teal px-6 text-ui-label text-white transition-colors hover:bg-teal-hover disabled:opacity-60"
      >
